...
\DHKMchange{Let's consider an alternative cone, i.e.,
...
\begin{proposition}
If there exists $A,A',A'', n_1,$ and $\boldsymbol{\omega}$ such that
...
\begin{proof}
Let's prove $\calC'_{\boldsymbol{\lambda}, \boldsymbol{\omega}, A''}
\subseteq 
